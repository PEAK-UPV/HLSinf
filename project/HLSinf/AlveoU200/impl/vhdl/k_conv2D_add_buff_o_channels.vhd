...
entity k_conv2D_add_buff_o_channels_ram is 
    generic(
...
architecture rtl of k_conv2D_add_buff_o_channels_ram is 
...
entity k_conv2D_add_buff_o_channels is
    generic (
...
architecture arch of k_conv2D_add_buff_o_channels is
    component k_conv2D_add_buff_o_channels_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    k_conv2D_add_buff_o_channels_ram_U :  component k_conv2D_add_buff_o_channels_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
