...
module k_conv2D_dataflow_in_loop_o_iter_loop_entry8 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (ptr_out_out_full_n == 1'b0) | (enable_relu_out_full_n == 1'b0) | (ptr_data_out_full_n == 1'b0) | (ptr_kernel_out_full_n == 1'b0) | (ptr_bias_out_full_n == 1'b0) | (global_offset_out_full_n == 1'b0) | (o_iter_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ptr_out_out_full_n == 1'b0) | (enable_relu_out_full_n == 1'b0) | (ptr_data_out_full_n == 1'b0) | (ptr_kernel_out_full_n == 1'b0) | (ptr_bias_out_full_n == 1'b0) | (global_offset_out_full_n == 1'b0) | (o_iter_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (ptr_out_out_full_n == 1'b0) | (enable_relu_out_full_n == 1'b0) | (ptr_data_out_full_n == 1'b0) | (ptr_kernel_out_full_n == 1'b0) | (ptr_bias_out_full_n == 1'b0) | (global_offset_out_full_n == 1'b0) | (o_iter_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign enable_relu_out_din = enable_relu;

assign global_offset_out_din = global_offset;

assign o_iter_out_din = o_iter;

assign ptr_bias_out_din = ptr_bias;

assign ptr_data_out_din = ptr_data;

assign ptr_kernel_out_din = ptr_kernel;

assign ptr_out_out_din = ptr_out;

assign start_out = real_start;

endmodule //k_conv2D_dataflow_in_loop_o_iter_loop_entry8
