set moduleName split_1_1_8_9_s
set isTopModule 0
...
set Spec2ImplPortList { 
	in_r { ap_fifo {  { in_r_dout fifo_data 0 8 }  { in_r_empty_n fifo_status 0 1 }  { in_r_read fifo_update 1 1 } } }
