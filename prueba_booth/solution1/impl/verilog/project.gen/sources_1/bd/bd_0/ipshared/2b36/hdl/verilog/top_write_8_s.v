...
reg   [0:0] icmp_ln417_reg_157;
reg   [0:0] icmp_ln417_reg_157_pp0_iter1_reg;
reg    gmem1_blk_n_B;
...
reg    ptr_blk_n;
reg   [3:0] addr_reg_98;
reg   [57:0] trunc_ln_reg_141;
wire   [3:0] add_ln421_fu_129_p2;
...
wire   [0:0] icmp_ln417_fu_135_p2;
reg   [511:0] tmp_reg_161;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
wire  signed [63:0] sext_ln417_fu_119_p1;
...
always @ (posedge ap_clk) begin
    if (((m_axi_gmem1_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        addr_reg_98 <= 4'd0;
    end else if (((icmp_ln417_fu_135_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln417_reg_157 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln_reg_141 <= {{ptr_dout[63:6]}};
    end
end

always @ (*) begin
    if ((icmp_ln417_fu_135_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln417_reg_157_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln417_reg_157 == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln417_reg_157 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        in_r_read = 1'b1;
    end else begin
        in_r_read = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln417_reg_157_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (ptr_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ptr_read = 1'b1;
    end else begin
        ptr_read = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln417_fu_135_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln417_fu_135_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln421_fu_129_p2 = (addr_reg_98 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln417_reg_157 == 1'd0) & (in_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln417_reg_157 == 1'd0) & (in_r_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln417_reg_157 == 1'd0) & (in_r_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (ptr_empty_n == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln417_reg_157 == 1'd0) & (in_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln417_reg_157_pp0_iter1_reg == 1'd0) & (m_axi_gmem1_WREADY == 1'b0));
end
...
assign icmp_ln417_fu_135_p2 = ((addr_reg_98 == 4'd8) ? 1'b1 : 1'b0);
...
assign m_axi_gmem1_AWADDR = sext_ln417_fu_119_p1;
...
assign m_axi_gmem1_AWLEN = 32'd8;
...
assign m_axi_gmem1_WDATA = tmp_reg_161;
...
assign sext_ln417_fu_119_p1 = $signed(trunc_ln_reg_141);

endmodule //top_write_8_s
