...
set solution_dir "/mnt/beegfs/gap/laumecha/prueba_booth/solution1"
set debug_dir "/mnt/beegfs/gap/laumecha/prueba_booth/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {top_mul_8ns_8ns_16_1_1
...
top_fifo_w32_d2_S
top_fifo_w512_d2_S
top_start_for_write_8_U0
top_start_for_split_1_1_8_9_U0
top_start_for_mul_1_2_8_9_128_U0
top_start_for_broadcast_1_1_2_8_1152_U0
top_start_for_add_2_16_9_128_U0
top_start_for_merge_1_2_16_128_U0
top_start_for_serialize_2_16_128_U0
top_control_s_axi
top_gmem2_m_axi
top_gmem_m_axi
top_gmem1_m_axi
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 x0_1 W 0x0 "Data signal of x0" {{0 32 x0 W 0 "Bit 31 to 0 of x0"}}} {0x14 x0_2 W 0x0 "Data signal of x0" {{0 32 x0 W 0 "Bit 63 to 32 of x0"}}} {0x1c x1_1 W 0x0 "Data signal of x1" {{0 32 x1 W 0 "Bit 31 to 0 of x1"}}} {0x20 x1_2 W 0x0 "Data signal of x1" {{0 32 x1 W 0 "Bit 63 to 32 of x1"}}} {0x28 x2_1 W 0x0 "Data signal of x2" {{0 32 x2 W 0 "Bit 31 to 0 of x2"}}} {0x2c x2_2 W 0x0 "Data signal of x2" {{0 32 x2 W 0 "Bit 63 to 32 of x2"}}} {0x34 x3_1 W 0x0 "Data signal of x3" {{0 32 x3 W 0 "Bit 31 to 0 of x3"}}} {0x38 x3_2 W 0x0 "Data signal of x3" {{0 32 x3 W 0 "Bit 63 to 32 of x3"}}} {0x40 w_1 W 0x0 "Data signal of w" {{0 32 w W 0 "Bit 31 to 0 of w"}}} {0x44 w_2 W 0x0 "Data signal of w" {{0 32 w W 0 "Bit 63 to 32 of w"}}} {0x4c y_1 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 31 to 0 of y"}}} {0x50 y_2 W 0x0 "Data signal of y" {{0 32 y W 0 "Bit 63 to 32 of y"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem2 m_axi_gmem3 m_axi_gmem4 m_axi_gmem5 m_axi_gmem m_axi_gmem1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.33 machine 64 combinational 0 latency 4499 II x}
