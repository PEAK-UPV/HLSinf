...
module RTLinf #(
  ...
  parameter NUM_KERNELS            = 1,    // number of kernels
  parameter LOG_NUM_KERNELS        = 1,    // number of bits to encode a kernel id
  parameter NUM_ACT_MEMORIES       = 1,    // number of activation memories
  parameter LOG_NUM_ACT_MEMORIES   = 1,    // number of bits to encode an activation memory id
  parameter NUM_WEIGHT_MEMORIES    = 1,    // number of weight memories
  parameter LOG_NUM_WEIGHT_MEMORIES= 1,    // number of bits to encode a weight memory id
  ...
  parameter REPETITION_DETECTION   = "yes", // whether we implement a kernel with repetition detection or not
  //
