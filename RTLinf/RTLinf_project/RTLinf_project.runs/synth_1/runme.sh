...
HD_PWD='/home/laumecha/HLSinf/RTLinf/RTLinf_project/RTLinf_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTLinf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTLinf.tcl
