...
echo ""
# check paths exist
echo "  checking paths existence"
[ ! -d "${BSP_PATH}" ] && echo -e "${RED}Directory ${BSP_PATH} DOES NOT exist."
[ ! -d "${IQ_BASE_DIR}" ] && echo -e"${RED}Directory ${IQ_BASE_DIR} DOES NOT exist."
[ ! -d "${INTELFPGAOCLSDKROOT}" ] && echo -e "${RED}Directory ${INTELFPGAOCLSDKROOT} DOES NOT exist."
[ ! -d "${QSYS_ROOTDIR}" ] && echo -e "${RED}Directory ${QSYS_ROOTDIR} DOES NOT exist."
