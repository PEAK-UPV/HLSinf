...
// MACROS
//-----------------------------------------------------------------------------
#define PRINT_HLS_DEBUG_SUMMARY
...
#define HLS_O_ITER_MONITOR (int)6
...
//
    ...
    printf ("   DT_bias_sum    =   %f  (%f)\n", (double)hls_dbg_dt[HLS_DBG_DT_bias_sum_IND], (float)JM10_to_complete); 
    printf ("   DT_kernel_sum  =   %f  (%f)\n", (double)hls_dbg_dt[HLS_DBG_DT_kernel_sum_IND], (float)JM10_to_complete);
    printf ("   DT_din_sum     =   %f  (%f)\n", (double)hls_dbg_dt[HLS_DBG_DT_din_sum_IND], (float)JM10_to_complete);
    printf ("   DT_dout_sum    =   %f  (%f)\n",(double) hls_dbg_dt[HLS_DBG_DT_dout_sum_IND], (float)JM10_to_complete);
    printf ("   \n");
