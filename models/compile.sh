...
g++ -c cpu.c           -I/opt/xilinx/xrt/include -I/opt/Xilinx/Vivado/2020.2/include -g -std=c++11 -I./../opencl/common/includes/xcl2
g++ -c stats.c         -I/opt/xilinx/xrt/include -I/opt/Xilinx/Vivado/2020.2/include -g -std=c++11 -I./../opencl/common/includes/xcl2
...
g++ stats.o cpu.o xcl2.o runner.o fpga.o fig.o in_out.o nodes.o initializers.o main.o model.o parsers.o utils.o -o txt2hlsinf -lOpenCL -lpthread -lrt -lstdc++ -L/opt/xilinx/xrt/lib
