...
g++ -c opencv.cpp -DRUNTIME_SUPPORT -DOPENCV_SUPPORT
g++ -c dataset.c  -DRUNTIME_SUPPORT
g++ dataset.o opencv.o stats.o cpu.o xcl2.o runner.o fpga.o fig.o in_out.o nodes.o initializers.o main.o model.o parsers.o utils.o -o hlsinf_runner -lOpenCL -fopenmp -lpthread -lrt -lstdc++ -L/opt/xilinx/xrt/lib `pkg-config --libs opencv`
