...
//
void serialize_and_filter(int I_ITER, int num_pixels, int channel_blocks, ihc::stream<read_block_t> &in, ihc::stream<data_type> &out, int first_channel, int I, int enable) {
