...
#endif
#ifdef DWS_CONV
  OCL_CHECK(err, buffer_k_dw[0]    = new cl::Buffer(context, /*CL_MEM_EXT_PTR_XILINX |*/ CL_MEM_READ_ONLY  | CL_MEM_USE_HOST_PTR , size_kernel_dw_in_bytes, &kernel_dw[0], &err));
  OCL_CHECK(err, buffer_k_pw[0]    = new cl::Buffer(context, /*CL_MEM_EXT_PTR_XILINX |*/ CL_MEM_READ_ONLY  | CL_MEM_USE_HOST_PTR , size_kernel_pw_in_bytes, &kernel_pw[0], &err));
#endif
